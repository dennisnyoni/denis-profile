...
export class HomeContactComponent implements OnInit {
  ...
  constructor(public el: ElementRef,
    ...
    this._mFormGroup = this.formBuilder.group({
      ...
      phone:['+1 000 000 0000', Validators.pattern(new RegExp("[0-9 ]{12}"))
  ...
  _onSubmit(): void {
    ...
    setTimeout(() => {
      ...
      //   this._resolvedCaptcha(value);//(token, value);
  ...
  _resolvedCaptcha(//token: string,
     value: ParamPostContact) {
    ...
    //if (!token) {
      ...
      console.log("value from resolved: ",value);//, token);
      this.addContact(value);
